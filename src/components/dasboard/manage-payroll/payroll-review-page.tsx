...
const PayrollReviewPage = () => {
  ...
  const canManagerReview = user?.role === "manager" || user?.role === "admin";
  const canGmReview = user?.role === "generalManager" || user?.role === "admin";
    ...
    <div className="space-y-6 px-4 py-6 sm:px-6 lg:px-8 xl:px-10">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Manager and General Manager review flow with explicit release action.
        </p>
      </div>
            ...
            <>
              ...
              {(selectedRun.managerDecision === "REJECTED" ||
                ...
                <div className="rounded-lg border border-orange-300/70 bg-orange-50/60 p-3 text-sm text-orange-900 dark:border-orange-900/40 dark:bg-orange-950/30 dark:text-orange-200">
                  <p className="font-medium">Returned To Clerk</p>
                  <p>
                    This run is back in draft due to rejection. Clerk/Admin can
