...
import { InstallmentPaymentDialog } from "@/components/dasboard/manage-deductions/installment-payment-dialog";
...
type EmployeeDeductionsDirectoryPageProps = {
  rolePath: "admin" | "generalManager" | "manager" | "clerk";
